...
<section class="shop-left-sidebar-page shop-header">
  ...
  <div class="container py-75">
      ...
      <ul class="grid-dots d-flex justify-content-center align-items-center list-unstyled grid-gap-sm">
        ...
        <li>
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="grid" role="img"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="24" width="24" class="grid-layout-dots ">
            <path
    ...
    <div class="grid grid-4-cols gy-4 grid-gap-md columns-2">
      <div class="grid-cols">
        <div class="item-box">
          ...
          <div class="d-flex justify-content-start clolor-box">
            <ul class="list-unstyled">
              <li title="orange">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffa500" viewBox="0 0 256 256">
        ...
        <div class="item-box">
          ...
          <div class="d-flex justify-content-start clolor-box">
            <ul class="list-unstyled">
              <li title="orange">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#977945" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
              <li title="purple">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#d966d9" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
              <li title="light-green">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#caffd6" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
      ...
      <div class="grid-cols">
        <div class="item-box">
          <div class="item-box-img">
            <a href="product-details.php">
              <img src="assets/images/shop-left-sidebar/light-green-1.jpg" alt="cloth image" class="wishlist-img-1" />
              <img src="assets/images/shop-left-sidebar/light-green-2.jpg" alt="cloth image" class="wishlist-img-2" />
            </a>
            <div class="list-product-btn-container">
              <div class="list-product-btn">
                <a href="#" class="box-icon box-bag">
          ...
          <div class="d-flex justify-content-start clolor-box">
            <ul class="list-unstyled">
              ...
              <li title="light-blue">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#a8bcd4" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
              <li title="dark-blue">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#00008b" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
              ...
              <li title="light-grey">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#d3d3d3" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
        ...
        <div class="item-box">
          ...
          <div class="d-flex justify-content-start clolor-box">
            <ul class="list-unstyled">
              ...
              <li title="beige">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#c8ad7f" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
        ...
        <div class="item-box">
          ...
          <div class="d-flex justify-content-start clolor-box">
            <ul class="list-unstyled">
              ...
              <li title="pink">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcc6de" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
              <li title="dark-pink">
                <span class="color">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffb6c1" viewBox="0 0 256 256">
                    <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z"></path>
                  </svg>
                </span>
              </li>
